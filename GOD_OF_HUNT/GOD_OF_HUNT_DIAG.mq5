//+------------------------------------------------------------------+
//|                                       GOD_OF_HUNT_DIAG.mq5   v1.18   |
//|  نسخهٔ اندازه‌گیری. رفتارش دقیقا مثل نسخهٔ اصلی است، فقط زمان هر بخش   |
//|  را می‌سنجد و در تب Experts می‌نویسد. برای کار روزمره استفاده نشود.    |
